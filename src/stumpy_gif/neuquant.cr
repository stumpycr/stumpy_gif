...
class NeuQuant
  ...
  def train(pixel)
    # returns [min_value, index of min_value]
    closest = @table.each_with_index.min_by { |e, i| e.distance(pixel) }
    i = closest[1]
